...
function Simulacro() {
    ...
    function changeDifficult(difficulty) {
        ...
        const indexedDB = {
            subjects: {
                ...userDB.subjects,
                [router.query.Bmateria.toLowerCase()]: {
                    ...userDB.subjects[router.query.Bmateria.toLowerCase()],
                    progress: {
                        ...userDB.subjects[router.query.Bmateria.toLowerCase()].progress,
                        [dataItem.id]: {
                            ...userDB.subjects[router.query.Bmateria.toLowerCase()].progress[dataItem.id],
                            difficulty
                        }
                    }
                }
    ...
    difficulty == 'F' && dataProgress && dataProgress.success >= 3 && dataProgress.mistakes * 3 <= dataProgress.success
        ? userDataUpdate(userDB, object, setUserData, null, `subjects/${router.query.Bmateria.toLowerCase()}/progress/${dataItem.id}`, indexedDB)
